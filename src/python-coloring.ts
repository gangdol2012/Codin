...
const semanticColoringThemeRules: monaco.editor.ITokenThemeRule[] = [
  ...
  { token: 'csharpNamespace', foreground: 'C8C8C8' },
  { token: 'csharpClass', foreground: '4EC9B0' },
  { token: 'csharpClass.declaration', foreground: '4EC9B0', fontStyle: 'bold' },
  { token: 'csharpRecord', foreground: '4EC9B0' },
  { token: 'csharpRecord.declaration', foreground: '4EC9B0', fontStyle: 'bold' },
  { token: 'csharpStruct', foreground: '4EC9B0' },
  { token: 'csharpStruct.declaration', foreground: '4EC9B0', fontStyle: 'bold' },
  { token: 'csharpInterface', foreground: '4EC9B0' },
  { token: 'csharpInterface.declaration', foreground: '4EC9B0', fontStyle: 'bold' },
  { token: 'csharpEnum', foreground: '4EC9B0' },
  { token: 'csharpEnum.declaration', foreground: '4EC9B0', fontStyle: 'bold' },
  { token: 'csharpDelegate', foreground: '4EC9B0' },
  { token: 'csharpTypeParameter', foreground: '4EC9B0', fontStyle: 'italic' },
  { token: 'csharpMethod', foreground: 'DCDCAA' },
  { token: 'csharpMethod.declaration', foreground: 'DCDCAA', fontStyle: 'bold' },
  { token: 'csharpMethod.async', foreground: 'DCDCAA', fontStyle: 'italic' },
  { token: 'csharpExtensionMethod', foreground: 'DCDCAA', fontStyle: 'italic' },
  { token: 'csharpConstructor', foreground: 'DCDCAA' },
  { token: 'csharpConstructor.declaration', foreground: 'DCDCAA', fontStyle: 'bold' },
  { token: 'csharpProperty', foreground: '9CDCFE' },
  { token: 'csharpProperty.readonly', foreground: '4FC1FF' },
  { token: 'csharpField', foreground: '9CDCFE' },
  { token: 'csharpField.readonly', foreground: '4FC1FF' },
  { token: 'csharpEvent', foreground: 'DCDCAA' },
  { token: 'csharpEnumMember', foreground: '4FC1FF' },
  { token: 'csharpParameter', foreground: '9CDCFE' },
  { token: 'csharpParameter.declaration', foreground: '9CDCFE', fontStyle: 'italic' },
  { token: 'csharpLocal', foreground: '9CDCFE' },
  { token: 'csharpConstant', foreground: '4FC1FF' },
  { token: 'csharpConstant.readonly', foreground: '4FC1FF' },
  { token: 'csharpLabel', foreground: 'D7BA7D' },
  { token: 'csharpKeyword', foreground: '569CD6' },
  { token: 'csharpControlKeyword', foreground: 'C586C0' },
  { token: 'csharpPreprocessor', foreground: 'C586C0' },
